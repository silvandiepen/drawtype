<template>
	<span class="icon icon--brush" :style="computedStyle">
		<svg
			version="1.1"
		...
		>
			<g>
				<path
					d="M58.478,137.529c-5.147,5.148-8.913,19.097-20.116,30.301c-18.509,18.509,24.648,14.883,44.683-3.971
		c8.181-7.699,9.421-20.259,2.246-27.527C78.27,129.22,66.241,129.766,58.478,137.529z"
				/>
				<path
					d="M181.145,38.971c-5.837-5.838-16.924-2.864-35.947,9.639c-13.734,9.027-29.548,21.916-41.268,33.636
