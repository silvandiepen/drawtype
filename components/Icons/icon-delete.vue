<template>
	<span class="icon icon--delete" :style="computedStyle">
		<svg
			version="1.1"
		...
		>
			<g>
				<path
					d="M67.186,50.211l-28,56c-0.563,1.126-0.563,2.452,0,3.578l28,56c0.678,1.355,2.063,2.211,3.578,2.211H173
		...
		z"
				/>
				<path
					d="M106.071,127.414L117,116.484l10.929,10.929c1.562,1.562,4.095,1.562,5.657,0l2.828-2.828c1.562-1.562,1.562-4.095,0-5.657
